...
if __name__ == '__main__':
    start_urls_list = [
# --- 机场索引与列表类 ---
        'https://t.me/s/jichang_list',      # 核心列表
        'https://t.me/s/v2cross',          # 常用机场分享
        'https://t.me/s/star_gleam',       # Xboard/V2Board 专项
        'https://t.me/s/jichangba',        # 机场情报吧
        'https://t.me/s/jichang_news',     # 机场动态与新开
        
        # --- 测速与推荐类 ---
        'https://t.me/s/vpnone',           # 机场测速与推荐
        'https://t.me/s/jichang_tuijian',  # 机场推荐大频道
        'https://t.me/s/v2ray_share',      # 节点与站点日常更新
        'https://t.me/s/New_Learner',      # 虽是综合资讯，但包含大量机场公告
        
        # --- 开发者与技术交流类 (常有新站指纹) ---
        'https://t.me/s/v2board_pro',      # V2Board 相关分享
        'https://t.me/s/xboard_news',      # Xboard 官方/关联动态
        'https://t.me/s/jichang_radar',    # 机场雷达
        'https://t.me/s/JichangReview',    # 机场评测网
        'https://t.me/s/A_share_log',      # 节点与网址分享日志
        
        # --- 小众/新开情报 ---
        'https://t.me/s/low_cost_jichang', # 低价机场情报
        'https://t.me/s/jichangtuijian',   # 另一个机场推荐频道
    ]
